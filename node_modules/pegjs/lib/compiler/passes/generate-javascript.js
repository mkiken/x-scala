...
module.exports = function(ast, options) {
  ...
  parts.push([
    ...
    '      }',
    '',
     // '   var offset = peg$currPos;',
 		'   var offset = peg$maxFailPos;',
 		'	if(offset < input.length){',
 			'   var range = 10;',
 		'   var lines = input.substr(0, offset).split("\\n").length-1;',
 		'   console.error("\\n!!Error occurs");',
 		'   console.error("------------------------");',
 		'   console.error(input.substr(Math.max(0, offset - range), Math.min(input.length - offset, 2*range)));',
 		'   console.error("------------------------" + "(around " + lines + " line.)\\n");',
 		' }',
